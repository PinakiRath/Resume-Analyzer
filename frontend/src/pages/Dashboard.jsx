      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {quickActions.map((action, index) => (
          <motion.div
            ...
            className="card hover:bg-dark-600 transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary"
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              step: 2,
              title: "AI Analysis",
              desc: "Our AI analyzes your resume for ATS compatibility",
            },
            {
              step: 3,
              title: "Get Results",
              desc: "Receive detailed analysis with improvement suggestions",
            },
          ].map(({ step, title, desc }) => (
