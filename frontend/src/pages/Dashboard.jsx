  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-400">Get started by uploading your resume for analysis</p>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-medium text-white">Upload Your Resume</h3>
              <p className="text-gray-400 text-sm">Upload your PDF resume to our secure platform</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="flex-shrink-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-white text-sm font-bold mr-3 mt-1">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Our AI analyzes your resume for ATS compatibility</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="flex-shrink-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-white text-sm font-bold mr-3 mt-1">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Receive detailed analysis with improvement suggestions</p>
            </div>
          </div>
        </div>
      </motion.div>
